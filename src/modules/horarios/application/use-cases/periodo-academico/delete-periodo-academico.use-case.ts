// filepath: g:\PROYECTOS\COLLEGE\BACK\src\modules\horarios\application\use-cases\periodo-academico\delete-periodo-academico.use-case.ts
...
@Injectable()
export class DeletePeriodoAcademicoUseCase {
  constructor(
  ...
  async execute(id: number, institucionId: number): Promise<PeriodoAcademico> {
    ...
    return this.periodoAcademicoRepository.delete(id, institucionId);
  }
}
